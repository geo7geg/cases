<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="milestones.aspx.cs" Inherits="WebApplication1.milestones" EnableEventValidation = "false"  UICulture="el-GR" Culture="el-GR" %>
    ...
    <div>
        ...
        <div class="textbox1">
            <ul class="nav nav-pills nav-justified">
                ...
                <li class="active"><a href="http://server/cases/milestones.aspx">Ορόσημα</a></li>
            </ul>
        </div>
        <div>
        ...
        <div class="textbox4">
            ...
            <asp:Panel ID="Panel1" runat="server" CssClass="textbox" Height="376px">
                <div class="textbox4">
                    <asp:Label ID="Label1" runat="server" Height="25px" Style="margin-right: 5px; margin-left: 0px; margin-top: 0px; margin-bottom: 0px;" Text="Ημερομηνία Ορόσημου*" Width="163px"></asp:Label>
                    ...
                    <br />
                    <asp:Label ID="Label3" runat="server" Height="36px" Style="margin-right: 16px; margin-left: 23px; margin-top: 0px; margin-bottom: 0px;" Text="Υπόθεση*" Width="74px"></asp:Label>
                    ...
                    <br />
                    <asp:Label ID="Label4" runat="server" Height="26px" Style="margin-right: 15px; margin-top: 0px; margin-bottom: 0px; margin-left: 46px;" Text="Αιτών" Width="50px"></asp:Label>
                    ...
                    <br />
                    <br />
                    <asp:Label ID="Label6" runat="server" Height="24px" Style="margin-right: 3px; margin-top: 0px; margin-bottom: 0px; margin-left: 6px;" Text="Υπεύθυνος Υλοποίησης" Width="155px"></asp:Label>
                    ...
                    <br />
                    <asp:Label ID="Label9" runat="server" Height="29px" Style="margin-right: 15px; margin-top: 0px; margin-bottom: 0px; margin-left: 23px;" Text="Περιγραφή" Width="71px"></asp:Label>
                    <asp:TextBox ID="perigrafi" runat="server" Height="22px" Style="margin-left: 8px; margin-top: 19px; margin-right: 1px;" TextMode="MultiLine" Width="162px"></asp:TextBox>
                    <br />
                    <br />
                    <asp:Label ID="Label7" runat="server" Height="26px" Style="margin: 0px;" Text="Τελική Ημερομηνία" Width="141px"></asp:Label>
                    <asp:TextBox ID="final_date" runat="server" CssClass="txtdate" Style="margin-right: 38px; margin-top: 0px; margin-bottom: 0px; margin-left: 12px;" Width="162px"></asp:TextBox>
                    <br />
                    <asp:Label ID="Label8" runat="server" Height="24px" Style="margin-right: 9px; margin-top: 0px; margin-bottom: 0px; margin-left: 7px;" Text="Καταληκτική Ημερομηνία" Width="186px"></asp:Label>
                    <asp:TextBox ID="close_date" runat="server" CssClass="txtdate" Style="margin-right: 87px; margin-top: 16px; margin-bottom: 0px; margin-left: 0px;" Width="162px"></asp:TextBox>
                    <br />
                    <br />
